...
class _SongService implements SongService {
  _SongService(this._dio, {this.baseUrl}) {
  ...
  @override
  Future<MusicResponse> getCatalogSong(storefront, id) async {
  ...
  @override
  Future<MusicResponse> getCatalogMusicVideo(storefront, id) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
