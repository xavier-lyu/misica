...
class _StationsService implements StationsService {
  _StationsService(this._dio, {this.baseUrl, this.errorLogger}) {
  ...
  @override
  Future<MusicResponse> fetchStationGenres(String storefront) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  @override
  Future<MusicResponse> fetchGenreStations(String storefront, String id) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
