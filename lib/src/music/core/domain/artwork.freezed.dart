...
abstract class $ArtworkCopyWith<$Res> {
  ...
  @useResult
  $Res call({String? bgColor, int height, String url, int width, String? textColor});
}
...
class __$$ArtworkImplCopyWithImpl<$Res> extends _$ArtworkCopyWithImpl<$Res, _$ArtworkImpl>
  ...
  __$$ArtworkImplCopyWithImpl(_$ArtworkImpl _value, $Res Function(_$ArtworkImpl) _then) : super(_value, _then);
...
class _$ArtworkImpl extends _Artwork {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, bgColor, height, url, width, textColor);
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$ArtworkImplCopyWith<_$ArtworkImpl> get copyWith => __$$ArtworkImplCopyWithImpl<_$ArtworkImpl>(this, _$identity);
