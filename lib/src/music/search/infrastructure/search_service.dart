...
abstract class SearchService {
  ...
  Future<SearchResultsDTO> search(@Path('storefront') storefront, @Path('term') term);
  ...
  Future<SearchSuggestionsResultsDTO> searchSuggestions(@Path('storefront') storefront, @Path('term') term);
}
