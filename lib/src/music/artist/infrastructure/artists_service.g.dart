...
class _ArtistsService implements ArtistsService {
  _ArtistsService(this._dio, {this.baseUrl}) {
  ...
  @override
  Future<MusicResponse> fetchArtist(storefront, id) async {
  ...
  @override
  Future<MusicResponse> defaultPlayableContent(storefront, id) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
