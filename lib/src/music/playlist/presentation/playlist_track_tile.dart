...
class PlaylistTrackTile extends StatelessWidget {
  const PlaylistTrackTile({super.key, required this.track, this.onTap});
  ...
  Widget build(BuildContext context) {
    return track.when(
      song: (value) => ResourceTile(resource: value, onTap: onTap),
      musicVideo: (value) => ResourceTile(resource: value, onTap: onTap),
    );
  }
}
