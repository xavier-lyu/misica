...
class PlaylistFooterView extends StatelessWidget {
  const PlaylistFooterView({super.key, required this.songsCount, required this.duration});
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        ...
        children: [Text('$songsCount ${context.loc.song}, ${duration.readable(context.loc.localeName)}')],
      ),
    );
  }
}
