...
class _PlaylistsService implements PlaylistsService {
  _PlaylistsService(this._dio, {this.baseUrl}) {
  ...
  @override
  Future<MusicResponse> fetchCatalogPlaylist(storefront, id) async {
  ...
  @override
  Future<MusicResponse> fetchCatalogPlaylistTracks(storefront, id) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
