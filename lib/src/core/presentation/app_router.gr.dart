...
import '../../music/library/presentation/library_page.dart' as _i9;
import '../../music/playlist/presentation/playlist_page.dart' as _i5;
import '../../music/radio/presentation/radio_page.dart' as _i8;
import '../../music/search/presentation/search_page.dart' as _i10;
...
class AppRouter extends _i11.RootStackRouter {
  ...
  final Map<String, _i11.PageFactory> pagesMap = {
    ...
    RadioRoute.name: (routeData) {
      return _i11.MaterialPageX<dynamic>(
          routeData: routeData, child: const _i8.RadioPage());
    },
    LibraryRoute.name: (routeData) {
      return _i11.MaterialPageX<dynamic>(
          routeData: routeData, child: const _i9.LibraryPage());
    },
  ...
  List<_i11.RouteConfig> get routes => [
        ...
        _i11.RouteConfig(AuthorizationRoute.name, path: '/auth'),
        _i11.RouteConfig(IndexRoute.name, path: '/', children: [
          _i11.RouteConfig(HomeRoute.name, path: '', parent: IndexRoute.name),
          _i11.RouteConfig(RadioRoute.name,
              path: 'radio', parent: IndexRoute.name),
          _i11.RouteConfig(LibraryRoute.name,
              path: 'library', parent: IndexRoute.name),
          _i11.RouteConfig(SearchRoute.name,
              path: 'page', parent: IndexRoute.name)
        ]),
        _i11.RouteConfig(AlbumRoute.name, path: '/album'),
        _i11.RouteConfig(PlaylistRoute.name, path: '/playlist'),
        _i11.RouteConfig(ArtistRoute.name, path: '/artist')
      ];
}
...
/// generated route for
/// [_i4.AlbumPage]
class AlbumRoute extends _i11.PageRouteInfo<AlbumRouteArgs> {
  AlbumRoute({_i12.Key? key, required String id})
...
class PlaylistRoute extends _i11.PageRouteInfo<PlaylistRouteArgs> {
  PlaylistRoute({_i12.Key? key, required String id})
...
/// generated route for
/// [_i6.ArtistPage]
class ArtistRoute extends _i11.PageRouteInfo<ArtistRouteArgs> {
  ArtistRoute({_i12.Key? key, required String id})
...
/// generated route for
/// [_i8.RadioPage]
class RadioRoute extends _i11.PageRouteInfo<void> {
