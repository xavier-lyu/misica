...
final credentialsStorageProvider =
    AutoDisposeProvider<SecureCredentialsStorage>.internal(
  credentialsStorage,
  name: r'credentialsStorageProvider',
  debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
      ? null
      : _$credentialsStorageHash,
  dependencies: null,
  allTransitiveDependencies: null,
);
...
final musicAuthenticatorProvider =
    AutoDisposeProvider<MusicAuthenticator>.internal(
  musicAuthenticator,
  name: r'musicAuthenticatorProvider',
  debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
      ? null
      : _$musicAuthenticatorHash,
  dependencies: null,
  allTransitiveDependencies: null,
);
...
final musicAuthIntercepterProvider =
    AutoDisposeProvider<MusicAuthIntercepter>.internal(
  musicAuthIntercepter,
  name: r'musicAuthIntercepterProvider',
  debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
      ? null
      : _$musicAuthIntercepterHash,
  dependencies: null,
  allTransitiveDependencies: null,
);
